    ...
    return (
      <div className="my-2 w-full h-auto md:h-24 bg-white shadow-xl flex flex-col sm:flex-row sm:justify-between rounded-xl">
        ...
        <div className="w-full md:w-fill flex flex-col md:flex-row p-2 items-start md:items-center justify-evenly">
          <div className="w-full md:w-1/12 flex flex-wrap justify-start mx-2 md:justify-center text-center">
          ...
          <div className="w-full md:w-2/12 flex flex-wrap justify-start mx-2 md:justify-center text-center">
            <div className="flex md:hidden mr-2 font-bold">Index : </div>
            {id}
          </div>
          <div className="w-full md:w-2/12 flex flex-wrap justify-start mx-2 md:justify-center text-center">
          ...
          <div className=" w-full md:w-2/12 flex mx-2 p-2 rounded-xl flex justify-center text-center items-center">
            <button
